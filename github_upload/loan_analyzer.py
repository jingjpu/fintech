...
print(f'total value of loans is ${sum_of_loans}')
...
average_loan=sum_of_loans/number_loans
print(f'the average laon amount is $ {average_loan}')
...
print(f'remaining there are {remaining_months} remaining')
...
# YOUR CODE HERE!
present_value=pv_calc (new_loan['future_value'], new_loan['remaining_months'],.2)
